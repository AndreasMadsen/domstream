...
Node.prototype.remove = function () {
  ...
  var elem = this.elem;
  var before = elem.pos[0],
      after = elem.pos[2] + elem.pos[3] + 1,
      move = before - after;
...
Node.prototype.trim = function () {
  ...
  var before = elem.pos[0] + elem.pos[1] + 1,
      after = elem.pos[2],
...
Node.prototype.setAttr = function (name, value) {
  ...
  after = before = elem.pos[0] + start + 1;
  move = length + 1;
...
Node.prototype.removeAttr = function (name) {
  ...
  // get postions and sizes
  var before = elem.pos[0] + attr.start,
...
var insertAdjacentMethods = {
  ...
  'afterbegin': function (node, elem, content, move) {
    ...
    // get positions and size
    var insert = elem.pos[0] + elem.pos[1] + 1;
  ...
  'afterend': function (node, elem, content, move) {
    ...
    // get positions and size
    var insert = elem.pos[2] + elem.pos[3] + 1;
