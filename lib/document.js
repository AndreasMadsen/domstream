...
Document.prototype._send = function (node) {
  ...
  if (modify === false) {
    ...
    // if other nodes exist, the position is the end of the endtag
    else if (elem.singleton) {
      next = pos.beforebegin + pos.afterbegin + 1;
    } else {
      next = pos.beforeend + pos.afterend + 1;
    }
  }
