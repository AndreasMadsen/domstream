...
describe('testing document search', function () {
  ...
  common.createTemplate(function (content) {
    ...
    describe('when searching with .only() using', function () {
      ...
      var links = [
        doc.tree.childrens[0].childrens[0].childrens[1],
        doc.tree.childrens[0].childrens[0].childrens[2]
      ];
    ...
    describe('when searching using', function () {
      var body = doc.tree.childrens[0].childrens[1];
      var items = body.childrens[1].childrens.concat(body.childrens.slice(2, 5));
